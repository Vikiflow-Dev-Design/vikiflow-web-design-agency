...
const teamRoles = [
  {
    ...
    description:
      "Our team tackles all aspects of client-side development, including layout, navigation, and interactivity.",
  },
  {
    icon: <Palette className="h-12 w-12" />,
    title: "UX/UI designers",
    description:
      "Side-by-side with engineers, our creative wizards translate design concepts into functional interfaces.",
  },
  {
    icon: <Database className="h-12 w-12" />,
    title: "Back-end engineers",
    description:
      "Our back-end team builds the server infrastructure and implements your application's core logic.",
  },
  {
    icon: <TestTube className="h-12 w-12" />,
    title: "QA engineers",
    description:
      "To meet all quality standards, our QA specialists perform testing at various stages of development.",
  },
  {
    icon: <UserCog className="h-12 w-12" />,
    title: "Project managers",
    description:
      "By establishing a clear dialogue between you and our team, we ensure every project milestone is met.",
  },
  {
    icon: <Settings className="h-12 w-12" />,
    title: "DevOps engineers",
    description:
      "For smoother workflows, our DevOps experts bridge the gap between development and operations teams.",
  },
];
