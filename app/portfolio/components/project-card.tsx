  ...
  return (
    <Card className="overflow-hidden group relative border-primary/20 bg-background/5 backdrop-blur-sm hover:border-primary/50 transition-colors duration-300">
      <div className="relative">
        {/* External Link Button - Moved outside of Link component */}
        <a
          href={project.link}
          target="_blank"
          rel="noopener noreferrer"
          className="absolute top-4 right-4 z-10 bg-background/80 backdrop-blur-sm p-2 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 hover:bg-primary/20"
